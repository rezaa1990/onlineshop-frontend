...
function Navbar() {
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg container-fluid position-fixed z-1 ${
        scrolled ? "py-0" : "py-3"
      }`}
      style={{
        opacity: ".9",
          ...
          <ul className="navbar-nav p-0">
            <li className="nav-item rounded">
              <Link
                ...
                style={{
                  backgroundColor: active == 1 ? "rgb(37, 0, 122)" : "",
                }}
            ...
            <li className="nav-item rounded">
              <Link
                ...
                className="nav-link text-white rounded"
                style={{
                  backgroundColor: active == 2 ? "rgb(37, 0, 122)" : "",
                }}
            ...
            <li
              className="nav-item mx-2 d-flex align-items-start rounded"
              style={{ backgroundColor: active == 3 ? "rgb(37, 0, 122)" : "" }}
              onClick={() => handleActive(3)}
            >
              <div
                className="text-white text-center px-2 d-xs-none d-none d-lg-block"
                style={{
                  backgroundColor: "red",
              ...
              <div
                className="text-white text-center px-2 d-lg-none"
                style={{
                  backgroundColor: "red",
                  borderTopLeftRadius: "40%",
                  borderTopRightRadius: "40%",
            ...
            <Dropdown
              className="rounded"
              style={{ backgroundColor: active == 4 ? "rgb(37, 0, 122)" : "" }}
              onClick={() => handleActive(4)}
            >
              <Dropdown.Toggle
                className="nav-item text-light border-0"
                variant=""
                id="nav-dropdown"
              >
                محصولات
              ...
              <Dropdown.Menu className="border p-0" id="nav-drop-down-menu">
                <Dropdown.Item
                  className="text-end text-light rounded"
                  onClick={() => setSearchValue()}
                  id="nav-drop-down-item"
                  href="#/accessories"
                >
                  پیش فرض
                </Dropdown.Item>
                ...
                <Dropdown.Item
                  className="text-end text-light rounded"
                  onClick={() => setSearchValue("لوازم جانبی")}
                  id="nav-drop-down-item"
                  href="#/accessories"
                >
                  لوازم جانبی
